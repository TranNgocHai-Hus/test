...
public class MainMenuUI : MonoBehaviour
{
    ...
    public GameObject ar15InfoPanel;
    ...
    private void Update()
    {
        ...
        {
            ar15Buybt.SetActive(false);
            ar15Buy.SetActive(false);
            ar15Equiped.SetActive(true);
        }
